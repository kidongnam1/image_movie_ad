...
with tempfile.TemporaryDirectory() as td:
    perf_db=Path(td)/"selftest_performance.sqlite"
    beauty=generate("세럼",performance_db=perf_db)
    assert beauty["version"]=="2.7"
    ...
    assert beauty["creative_registry"]["registered_candidates"]==3
    ...
    assert golf["creative_registry"]["registered_candidates"]==3
