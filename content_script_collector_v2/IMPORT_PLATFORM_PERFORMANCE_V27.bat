...
python generator\platform_performance_adapter_v27.py "%FILE%" --platform %PLATFORM% --default-product "%PRODUCT%" --default-category "%CATEGORY%" > outputs\platform_import_report_v27.json
if errorlevel 1 goto FAIL
type outputs\platform_import_report_v27.json
...
echo Import report: outputs\platform_import_report_v27.json
