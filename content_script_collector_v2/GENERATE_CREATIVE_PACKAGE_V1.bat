...
echo ==========================================================
echo Creative Package - V2.6 성과학습 Script Engine 연동
echo ==========================================================
echo.
...
echo.
echo CREATIVE PACKAGE PASS - V2.6 Performance Learning
echo 결과 폴더: outputs_creative
echo UGC / Product Demo / Cinematic + performance_learning.json + experiment_plan.json 을 확인하세요.
pause
exit /b 0
