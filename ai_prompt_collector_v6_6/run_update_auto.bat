...
%PY% refresh_manifest_views.py || goto FAIL
%PY% validate_manifest.py || goto FAIL
%PY% collect_and_index.py --root "%LIB%" --priority 3 --include-tooling --retries 3 --retry-delay 4 --clone-timeout 1200 --text-only-clone
