...
echo ==========================================================
echo AI Prompt Collector v6 - DOWNLOAD 63 CORPUS ONLY
echo ==========================================================
echo Target: 63 active corpus repositories
echo Download only ^(no tooling, no indexing^)
set "PY=python"
...
%PY% download_only.py --root "%LIB%" --priority 3 --retries 4 --retry-delay 5 --clone-timeout 1200 --text-only-clone
if errorlevel 1 goto FAIL
